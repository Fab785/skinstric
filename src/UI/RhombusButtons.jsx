        ...
        <div className="relative w-full max-w-xl text-center">
          ...
          <div className="relative inline-block">
            <input
              ...
              className={`bg-transparent outline-none text-[40px] text-black text-center font-normal placeholder-transparent caret-black pt-2 relative z-10 transition-all duration-200 w-[auto] ${
                labelClicked || inputFocused || hasText
